...
#7個のデータで1セットとする　点灯時間(ms)、向かって右LEDのRGB、左LEDのRGB
...
class tblRobotLED:
    def __init__(self):
        self.DATA = [
            [0,   0,  0,  0,  0,  0,  0,  0],   #初期値
            [1,3000,100,  0,  0,  0,  0,100],   #3秒点灯
            [2,1000,100,100,100,100,100,100,1000,0,0,0,0,0,0,1000,100,100,100,100,100,100],    #1秒インターバルの点滅
            [3,1000,100,0,0,0,0,100,1000,0,100,0,100,0,0,1000,0,0,100,0,100,0]  #1秒毎に色を変えていく
